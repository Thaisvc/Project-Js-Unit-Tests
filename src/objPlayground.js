...
// object keys,value e entries = https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Object/keys
const arrayGenerator = (tipoConvert, object) => {
  if (tipoConvert === 'keys') return Object.keys(object);
  if (tipoConvert === 'values') return Object.values(object);
  if (tipoConvert === 'entries') return Object.entries(object);
 };
